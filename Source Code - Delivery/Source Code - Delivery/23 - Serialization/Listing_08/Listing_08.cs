...
class Person {
    ...
    public void OnDeserializing(StreamingContext context) {
        Console.WriteLine("OnDeserializing method called");
        city = "London";
    }
}
...
class Listing_08_Test {
    ...
    static void Main(string[] args) {
        ...
        Person myPerson = new Person("Adam Freeman", "Paris");
        ...
        Console.WriteLine("Deserialized name: {0}", deserializedPerson.City);
