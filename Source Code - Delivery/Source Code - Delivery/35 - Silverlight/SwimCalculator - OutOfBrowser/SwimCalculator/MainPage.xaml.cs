    ...
    public partial class MainPage : UserControl {
        ...
        private void UserControl_Loaded(object sender, RoutedEventArgs e) {
            ...
            if (Application.Current.IsRunningOutOfBrowser) {
                ...
                convertButton.SetValue(Grid.RowSpanProperty, 2);
            } else {
                // set the inital state of the install button
                setButtonState();
                // register a handler for the event invoked when the install state changes
                Application.Current.InstallStateChanged += (innerSender, eventArgs) => {
                    setButtonState();
                };
            }
        }
