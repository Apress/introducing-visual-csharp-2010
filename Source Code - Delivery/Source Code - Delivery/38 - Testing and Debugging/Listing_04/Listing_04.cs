...
class Calculator {
    ...
    public int CalculateDivision(int x, int y) {
        Debug.WriteLine("Entered CalculateDivision Method");
        Debug.Indent();
        Debug.WriteLine("Parameters are: {0} {1}", x, y);
        Debug.WriteLineIf(y == 0, "Second parameter is zero");
        Debug.Unindent();
        Debug.WriteLine("Exiting CalculateDivision Method");
        return x / y;
    }
}
